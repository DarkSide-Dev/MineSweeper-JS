...
function preencherContainer(){
    ...
    for(let i = 0; i < quant_tabuleiro; i++){
        ...
        if(window.screen.width <= 420){
            ...
            container.innerHTML += `<div id="bomb${i}" onselect="flag(${i}); return false;" ondblclick="flag(${i}); return false;" oncontextmenu="flag(${i}); return false;" onclick="verificar(${i})" class="block">.</div>`;
